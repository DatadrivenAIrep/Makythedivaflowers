  ...
  return (
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <StaggerGroup as="ul" className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {CASES.map((c, i) => (
            <StaggerItem as="li" key={c} className="rounded-2xl border border-ink/10 bg-bone p-6 hover:border-rouge/40 transition-colors motion-reduce:transition-none">

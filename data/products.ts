...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "arrangements",
    blurb: {
      en: "Blush hydrangea, cream roses and pink lisianthus with snowberry and eucalyptus, low in a glass cube — with or without pink dendrobium orchids.",
      es: "Hortensia blush, rosas crema y lisianthus rosa con snowberry y eucalipto, bajo en un cubo de vidrio — con o sin orquídeas dendrobium rosas.",
    },
    description: {
      en: "For the gift that should feel like a whisper — a low, soft arrangement in blush and cream: pale pink hydrangea and cream roses at the heart, blush spray roses and pink lisianthus tucked between them, pink snowberry for a little sparkle, and trailing eucalyptus spilling over the edge of a clear glass cube. Choose it as it is, or add sprays of pink dendrobium orchid rising above it all; both versions are in the photos, and the price follows your choice. It is the palette of a ballet slipper, of tissue paper, of the first morning with a new baby: quiet from across the room and full of detail up close, with nothing loud in it anywhere. Low enough for a nightstand or a breakfast tray, pretty enough for the center of a bridal luncheon. Send it for the new baby, the bridal shower, the anniversary, the birthday of the person who prefers soft to bright. Order before 2:00 pm and it goes out today across Long Island, built to the photo in the same palette with whatever came in freshest that morning.",
      es: "Para el regalo que debería sentirse como un susurro — un arreglo bajo y suave en blush y crema: hortensia rosa pálido y rosas crema en el corazón, rosas spray blush y lisianthus rosa metidos entre ellas, snowberry rosa para un poco de brillo, y eucalipto colgante que se derrama por el borde de un cubo de vidrio transparente. Elígelo tal cual, o súmale varas de orquídea dendrobium rosa que suben por encima de todo; las dos versiones están en las fotos, y el precio sigue tu elección. Es la paleta de una zapatilla de ballet, del papel de seda, de la primera mañana con un bebé nuevo: silencioso desde el otro lado del cuarto y lleno de detalle de cerca, sin nada estridente en ninguna parte. Bajo para una mesa de noche o una bandeja de desayuno, y bonito para el centro de un almuerzo de novia. Mándalo por el bebé nuevo, el bridal shower, el aniversario, el cumpleaños de quien prefiere lo suave a lo brillante. Pídelo antes de las 2:00 pm y sale hoy mismo por Long Island, armado como la foto en la misma paleta con lo que haya entrado más fresco esa mañana.",
    },
    images: [
      { src: "/products/ballet-slipper.jpg", alt: { en: "Low blush arrangement of pale pink hydrangea, cream roses, pink lisianthus, snowberry and trailing eucalyptus in a glass cube", es: "Arreglo blush bajo de hortensia rosa pálido, rosas crema, lisianthus rosa, snowberry y eucalipto colgante en cubo de vidrio" }, aspect: "4/5" },
      { src: "/products/ballet-slipper-2.jpg", alt: { en: "Ballet Slipper with sprays of pink dendrobium orchid added above the roses and hydrangea", es: "Zapatilla de Ballet con varas de orquídea dendrobium rosa añadidas sobre las rosas y la hortensia" }, aspect: "4/5" },
      { src: "/products/ballet-slipper-3.jpg", alt: { en: "Ballet Slipper seen from above, cream roses and pink lisianthus over blush hydrangea", es: "Zapatilla de Ballet vista desde arriba, rosas crema y lisianthus rosa sobre hortensia blush" }, aspect: "4/5" },
    ],
    variants: [
      { id: "no-orchid", label: { en: "Without orchid", es: "Sin orquídea" }, priceCents: 10000, subtitle: { en: "Roses, hydrangea, lisianthus", es: "Rosas, hortensia, lisianthus" } },
      { id: "with-orchid", label: { en: "With orchid", es: "Con orquídea" }, priceCents: 11000, subtitle: { en: "Adds sprays of pink dendrobium", es: "Suma varas de dendrobium rosa" } },
    ],
    tags: ["new", "same-day", "staff-pick"],
    ...
    seo: {
      ...
      description: {
        en: "A low blush arrangement of pale pink hydrangea, cream roses and pink lisianthus with snowberry and eucalyptus in a glass cube, with or without pink dendrobium orchids. Same-day delivery on Long Island.",
        es: "Arreglo blush bajo de hortensia rosa pálido, rosas crema y lisianthus rosa con snowberry y eucalipto en cubo de vidrio, con o sin orquídeas dendrobium rosas. Entrega el mismo día en Long Island.",
      },
    },
  },
  {
